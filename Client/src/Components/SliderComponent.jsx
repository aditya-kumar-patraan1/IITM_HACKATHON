      ...
      <div className="w-screen h-[100%] px-8 lg:px-12 bg-[#FFFFFF] ">
        <div className="grid lg:grid-cols-2 gap-12 h-[100%] items-center">
          ...
          <div className="space-y-8">
            ...
            <button className="bg-white block mx-0 border border-black text-black px-5 p-3 text-sm rounded-full w-fit h-auto  hover:text-white hover:bg-black font-bold cursor-pointer hover:shadow shadow-gray-500 transition-all duration-300" onClick={()=>window.open("/BlogTop","__blank")}>Learn for free</button>
            </div>
          </div>
