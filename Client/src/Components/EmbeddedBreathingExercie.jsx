...
const EmbeddedBreathingExercie = () => {
 ...
 return (
    ...
    <div className="flex flex-col h-fit w-full max-w-lg bg-[#EFF0F2] rounded-2xl shadow-lg items-center p-6 space-y-6">
      ...
      <div className="relative w-64 h-64 flex items-center justify-center">
          ...
          animate={
            isActive
              ? {
                  ...
                  boxShadow: [
                    "0 0 20px rgba(16, 24, 40, 0.5)",
                    "0 0 40px rgba(16, 24, 40, 0.7)",
                    "0 0 20px rgba(16, 24, 40, 0.5)",
                  ],
                }
              : { scale: 1 }
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white font-light">
          <div className="text-2xl font-medium mb-1">{timeRemaining}</div>
      ...
      <div className="flex items-center space-x-4">
        <button
          ...
          className="p-3 rounded-full bg-gray-200 hover:bg-gray-300 transition-all duration-200 group"
        >
        ...
        <div className="text-sm text-gray-600 font-medium w-12 text-center">
          Cycle {cycleCount}
        </div>
      </div>
      ...
      <div className="bg-gray-50 rounded-xl p-4 w-full border border-gray-200">
        ...
        <div className="grid grid-cols-4 gap-3 text-xs">
          {phases.map((phase) => (
            ...
            >
              <div className={`font-medium ${currentPhase === phase ? "text-white" : "text-gray-900"}`}>
                {phaseConfig[phase].label}
              </div>
              <div className={`${currentPhase === phase ? "text-gray-200" : "text-gray-500"}`}>
